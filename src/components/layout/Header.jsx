    ...
    <div className={`${ scrolled ? styles.sticky : styles.header }`} >
      <div className='sticky flex items-center w-full h-24'>
          <nav id='header'  className='relative z-30 flex justify-between w-full px-3 lg:justify-center lg:items-center'>
              ...
              >
                  <li><Link onClick={() => setOffCanvas(false)} to='main' offset={-100} smooth={true} duration={500}><img className='w-24 my-10 rounded-lg md:hidden' src={Logo} alt="Casta logo ul"/></Link></li>
              ...
              <div onClick={() => offCanvas ? setOffCanvas(false) : setOffCanvas(true)} className='flex items-center self-center justify-center p-3 mr-4 text-white rounded-full bg-[#01b1af] h-14 w-14 lg:hidden'>
