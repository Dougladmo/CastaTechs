    ...
    <div className={`${ scrolled ? styles.sticky : styles.header }`} >
      <div className='sticky flex items-center w-full h-24'>
          <nav id='header'  className='relative z-30 flex justify-between w-full px-3 lg:justify-center lg:items-center'>
              ...
              >
                  <li><Link onClick={() => setOffCanvas(false)} to='main' offset={-100} smooth={true} duration={500} aria-label="Logo offcanvas"><img className='w-24 my-10 rounded-lg md:hidden' src={Logo} alt="Casta logo ul"/></Link></li>
                  <li className='pb-3 mb-3 border-b-2 border-gray-300 lg:py-1 lg:mb-0 lg:border-b-0 lg:px-12 lg:border-r-2 lg:border-[#242424]'><Link to='main' onClick={() => setOffCanvas(false)} className='transition duration-500 cursor-pointer hover:text-white md:hover:text-blue-500' offset={-100} smooth={true} duration={500} >Home</Link></li>
